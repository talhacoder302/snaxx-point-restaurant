          ...
          <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
            <Reveal>
              <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-ink px-6 py-16 text-center shadow-[0_30px_80px_rgba(0,0,0,0.35)] sm:px-12 sm:py-20">
                ...
                <div className="relative inline-flex items-center gap-2.5 rounded-full border border-ember/25 bg-ember/10 px-4 py-2 text-base font-bold uppercase tracking-[1.8px] text-ember-glow">
